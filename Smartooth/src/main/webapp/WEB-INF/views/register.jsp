...
<!-- 	<form id="frm" name="frm" action="/app/user/login.do" method="post"> -->
	<form id="frm" name="frm" action="/app/user/register.do" method="post">
		<input type="text" id="USER_ID" name="USER_ID" value="jungjuhyun12@gmail.com"/> 
		<input type="text" id="USER_PWD" name="USER_PWD" value="1234"/> 
		<input type="text" id="USER_TYPE" name="USER_TYPE" value="I"/> 
		<input type="text" id="USER_NM" name="USER_NM" value="관리자"/> 
		<input type="text" id="USER_NICKNAME" name="USER_NICKNAME" value="프론트맨"/> 
		<input type="text" id="USER_BIRTHDAY" name="USER_BIRTHDAY" value="1988-01-11"/> 
		<input type="text" id="USER_COUNTRY" name="USER_COUNTRY" value="KR"/> 
		<input type="text" id="USER_STATE" name="USER_STATE" value=""/> 
		<input type="text" id="USER_ADDRESS" name="USER_ADDRESS" value="서울시 신정동 1004-11 102호"/> 
		<input type="text" id="USER_TEL_NO" name="USER_TEL_NO" value="010-9963-4921"/> 
		<input type="text" id="USER_SEX" name="USER_SEX" value="M"/> 
		<input type="text" id="PUSH_TOKEN" name="PUSH_TOKEN" value="P.U.S.H.T.O.K.E.N"/> 
		<input type="text" id="TEETH_STATUS" name="TEETH_STATUS" value="123|456|678|901"/> 
